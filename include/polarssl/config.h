...
#define POLARSSL_PLATFORM_STD_MEM_HDR
#define POLARSSL_PLATFORM_STD_MALLOC(v)   kmalloc(v, GFP_KERNEL) /**< Default allocator to use, can be undefined */
#define POLARSSL_PLATFORM_STD_FREE       kfree /**< Default free to use, can be undefined */
#define POLARSSL_PLATFORM_STD_PRINTF(...)   printk(KERN_INFO __VA_ARGS__) /**< Default printf to use, can be undefined */
#define POLARSSL_PLATFORM_STD_FPRINTF(f, ...) printk(KERN_INFO __VA_ARGS__) /**< Default fprintf to use, can be undefined */
